...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @if(Auth::user()->authority != 3)
            <li class="nav-item">
                <a class="nav-link" href="/userall">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <!--ユーザー一覧の表示-->
                    <span>ユーザー管理</span></a>
            </li>
                @endif
            <!--これで権限のない場合は消えます。権限が3のときに消えます。-->
            
            <!-- <li class="nav-item">-->
            <!--        <a class="nav-link" href="/userregister">ユーザー登録</a>-->
            <!--        <i class="fas fa-fw fa-tachometer-alt"></i>-->
                    <!--user一覧の表示-->
            <!--        <span>ユーザー登録</span></a>-->
            <!--</li>-->
            ...
            <!--@if(Auth::user()->authority == 1)-->
            <!-- <li class="nav-item">-->
            <!--        <a class="nav-link" href="/registercompany"></a>-->
            <!--        <i class="fas fa-fw fa-tachometer-alt"></i>-->
            <!--        <span>企業代表アカウント登録</span></a>-->
            <!--</li>-->
            <!--@endif-->
            ...
            <li class="nav-item">
                <a class="nav-link" href="/fukugyousakis">
                    <i class="fas fa-fw fa-table"></i>
                    <span>副業先一覧</span></a>
            </li>
            ...
            <!--<li class="nav-item active">-->
                   <!--これでも行ける-->
            <!--    <a class="nav-link" href="newpost.blade.php">-->
            <!--        <i class="fas fa-fw fa-table"></i>-->
            <!--        <span>メッセージ</span></a>-->
            <!--</li>-->
            ...
            <!--<li class="nav-item">-->
                   <!--これでも行ける-->
            <!--    <a class="nav-link" href="/showmessege">-->
            <!--        <i class="fas fa-fw fa-table"></i>-->
            <!--        <span>メッセージ一覧</span></a>-->
            <!--</li>-->
