...
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">２０２１年実績</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                              <div style="width:70%">
                                 <button type="url" class="btn btn-success" style="float:right;"><a href="/showchart2022" class="text-decoration-none text-white">→2022年</a></button>
