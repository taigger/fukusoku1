            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('userregister') }}">
                        ...
                        　　<div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">所属組織</label>
                              <div class="col-md-6">
                            <select class="form-control" name="organization">
                                @foreach($organizations as $organization)
                                <option value="{{$organization->organization}}">{{$organization->organization}}</option>
                                @endforeach
                            </select>
                            </div>
                        </div>
